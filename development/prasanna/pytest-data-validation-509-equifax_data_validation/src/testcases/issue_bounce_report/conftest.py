...
from src.testcases.issue_bounce_report.issue_bounce_report_testcase_helper import TestIssueBounceHelper
...
@pytest.fixture(scope="session", autouse=True)
def create_issue_bounce_object(create_generic_object):
    testdemo_obj = TestIssueBounceHelper(create_generic_object)
    return testdemo_obj
