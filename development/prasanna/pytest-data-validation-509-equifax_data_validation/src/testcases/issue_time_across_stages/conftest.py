...
from src.testcases.issue_time_across_stages.issue_time_across_stages_testcase_helper import \
    TestIssueTimeAcrossStagesHelper
...
@pytest.fixture(scope="session", autouse=True)
def create_issue_time_across_stages_object(create_generic_object):
    testdemo_obj = TestIssueTimeAcrossStagesHelper(create_generic_object)
    return testdemo_obj
