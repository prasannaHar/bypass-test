...
from src.testcases.issue_resolution_time_report.issue_resolution_time_report_testcase_helper import \
    TestIssueResolutionTimetHelper
...
@pytest.fixture(scope="session", autouse=True)
def create_issue_resolution_time_report_object(create_generic_object):
    testdemo_obj = TestIssueResolutionTimetHelper(create_generic_object)
    return testdemo_obj
