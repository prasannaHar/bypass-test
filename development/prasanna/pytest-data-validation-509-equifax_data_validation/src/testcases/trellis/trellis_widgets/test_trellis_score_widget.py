...
class TestTrellisScoreReport:
    ...
    def test_trellis_score_report_tc001_widget_creation_rbac(self, create_widget_helper_object, rbacusertype,
    ...
    def test_trellis_score_report_tc001_widget_creation(self, create_widget_helper_object,req_interval,
    ...
    @pytest.mark.parametrize("req_interval", req_interval)
    def test_trellis_score_report_tc002_invalid_scores_check(self, create_widget_helper_object,req_interval,
                                                             create_generic_object, create_customer_object):
        """Validate trellis score report functionality invalid scores check """
    ...
    @pytest.mark.parametrize("req_interval", req_interval)
    def test_trellis_score_report_tc003_ou_associated_users_check(self, create_widget_helper_object, ou_helper_object,
                                                             create_generic_object, create_customer_object, req_interval):
        """Validate trellis score report functionality - ou associated users check """
        ...
        for org_id in org_ids:
            try:
                ...
                executed_flag, valid_data_flag = create_customer_object.trellis_data_validator(response=response_data,
                                                                                               ...
                                                                                               ou_users=ou_users, columns=columns)
                if not executed_flag:
                    not_executed_list.append(org_id)
                if not valid_data_flag:
                    invalid_ou_data_list.append(org_id)
