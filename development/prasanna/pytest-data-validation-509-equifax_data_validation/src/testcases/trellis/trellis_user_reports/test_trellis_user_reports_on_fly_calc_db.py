...
class TestTrellisUserReports:
    ...
    def test_trellis_user_data_consistency_widget_drilldown_on_the_fly_calculation_db(self,create_generic_object,ou_user_id, time_period):
        ...
        failure_details_if_any = trellisresult(
            ...
            on_fly_calc=True, force_source="db")
