...
class TestSCMCommitsSingleStatCustomer:
    ...
    def test_scm_commits_single_stat_report_es(self, agg_type, create_generic_object,
    ...
    def test_scm_commits_single_stat_report_es_filter(self, filter_type, create_generic_object,
                                                      create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
        zero_list = []
        list_not_match = []
    ...
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_scm_commits_single_stat_report_es_excludefilter(self, filter_type, create_generic_object,
                                                             create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
        zero_list = []
        list_not_match = []
    ...
    def test_scm_commits_single_stat_report_es_partialmatchfilter(self, create_generic_object,
                                                                  create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
        zero_list = []
        list_not_match = []
        ...
        for val in df_sprint:
            try:
                filters = {"agg_type": "average", "time_period": 30, "code_change_size_unit": "files",
                           "code_change_size_config": {"small": "50", "medium": "150"}, "visualization": "pie_chart",
                           "committed_at": {"$gt": gt, "$lt": lt}, "integration_ids": get_integration_obj,
