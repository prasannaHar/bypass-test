...
class TestScmIssuesFirstResposeReportCustomer:
    generic_object = TGhelper()
    across_type = generic_object.api_data["scm-issues-report"]
    ...
    def test_scm_issues_first_response_report_es(self, across_type, drilldown_object, create_generic_object,
    ...
    def test_scm_issues_first_response_report_es_filter(self, filter_type, create_generic_object,
                                                        create_customer_object, get_integration_obj):
    ...
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_scm_issues_first_response_report_es_excludefilter(self, filter_type, create_generic_object,
                                                               create_customer_object, get_integration_obj):
    ...
    def test_scm_issues_first_response_report_es_partialmatchfilter(self, create_generic_object,
                                                                    create_customer_object, get_integration_obj):
