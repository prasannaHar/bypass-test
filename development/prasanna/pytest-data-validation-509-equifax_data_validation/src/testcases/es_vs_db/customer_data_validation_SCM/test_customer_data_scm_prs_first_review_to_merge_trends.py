...
class TestScmFirstReviewMergeTrendsReportsCustomer:
    generic_object = TGhelper()
    filter_type = generic_object.api_data["scm_prs_report_filter_types"]

    @pytest.mark.run(order=1)
    @pytest.mark.esvsdbscm
    def test_scm_prs_first_review_to_merge_trends_report(self, create_generic_object,
        ...
        for val in df_sprint:
            try:
                ...
                es_base_url = create_generic_object.connection[
                                  ...
                                  "scm-prs-first_review_to_merge-trends"] + "?there_is_no_cache=true&force_source=es"
                ...
                db_base_url = create_generic_object.connection[
                                  "base_url"] + create_generic_object.api_data[
                                  "scm-prs-first_review_to_merge-trends"] + "?there_is_no_cache=true&force_source=db"
    ...
    def test_scm_prs_first_review_to_merge_trends_single_stat_report(self, create_generic_object,
                                                                     create_customer_object, get_integration_obj):
    ...
    def test_scm_prs_first_review_to_merge_trends_report_es_filter(self, filter_type, create_generic_object,
                                                                   create_customer_object, get_integration_obj):
    ...
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_scm_prs_first_review_to_merge_trends_report_es_excludefilter(self, filter_type, create_generic_object,
                                                                          create_customer_object, get_integration_obj):
    ...
    def test_scm_prs_first_review_to_merge_trends_report_es_partialmatchfilter(self, create_generic_object,
    ...
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_scm_prs_first_review_to_merge_trends_single_stat_report_es_filter(self, filter_type, create_generic_object,
                                                                               create_customer_object,
                                                                               get_integration_obj):
    ...
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_scm_prs_first_review_to_merge_trends_single_stat_report_es_excludefilter(self, filter_type,
    ...
    def test_scm_prs_first_review_to_merge_trends_single_stat_report_es_partialmatchfilter(self, create_generic_object,
                                                                                           create_customer_object,
                                                                                           get_integration_obj):
