...
from src.testcases.es_vs_db.aggs_data_validation.sql_query import SqlQuery
from src.testcases.es_vs_db.aggs_data_validation.sql_query_gitlab import SqlQueryGitlab
...
@pytest.fixture(scope="session")
def create_sql_query_object_gitlab():
    sql_object = SqlQueryGitlab()
    return sql_object
