...
class TestTrellisOptimisationTestingES:

    @pytest.mark.run(order=1)
    def test_trellis_user_reports_table_es(self, create_generic_object, create_postgres_object,
        ...
        try:
            existingflow_query= create_sql_query_object.terllis_optimisation_query_generator_user_reports(
                                                ...
                                                table_name="user_dev_productivity_es_reports")
            ...
            result_flag, execution_flag = create_customer_object.aggs_db_data_validator(
                ...
                tc_identifier="ES - trellis optimisation user db tables check")
