...
class TestIssuesCustomer:
    ...
    def test_sprint_metrics_percentage_trend_report_jira_es(self, across_type, create_generic_object,
        ...
        for val in df_sprint:
            try:
                filters = {"metric":["commit_done_ratio","creep_done_to_commit_ratio","done_to_commit_ratio","creep_to_commit_ratio","creep_missed_ratio","commit_missed_ratio","creep_done_ratio"],
    ...
    def test_sprint_metrics_percentage_trend_report_jira_es_filters(self, filter_type, create_generic_object,
                                                                    create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
        ...
        for val in df_sprint:
            try:
                ...
                filters = {"metric": ["commit_done_ratio", "creep_done_to_commit_ratio", "done_to_commit_ratio",
                                      "creep_to_commit_ratio", "creep_missed_ratio", "commit_missed_ratio",
                                      "creep_done_ratio"],
                           "completed_at": {"$gt": gt, "$lt": lt},
                           "integration_ids": get_integration_obj,
                           "agg_type": "average"
                ...
                payload = {"filter": filters, "across": "bi_week", "interval": "week",
                           "ou_ids": [val],
                           "ou_user_filter_designation": {"sprint": ["sprint_report "]}}
    ...
    @pytest.mark.esdbfilter
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_sprint_metrics_percentage_trend_report_jira_es_exclude_filters(self, filter_type, create_generic_object,
    ...
    def test_sprint_metrics_percentage_trend_report_jira_es_dashboard_partial_filters(self, dashboard_partial,
