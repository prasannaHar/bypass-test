...
class TestAssigneeCustomer:
    ...
    def test_first_assignee_report(self, across_type, create_generic_object,
        ...
        for val in df_sprint:
            try:
                ...
                payload = {"filter": filters, "across": across_type,
                           "ou_ids": [val],
                           "sort": [{"id": "assign_to_resolve", "desc": "True"}],
                ...
                es_base_url = create_generic_object.connection[
                                  ...
                                  "jira_first_assignee"] + "?there_is_no_cache=true&force_source=es"
                ...
                db_base_url = create_generic_object.connection[
                                  "base_url"] + create_generic_object.api_data[
                                  "jira_first_assignee"] + "?there_is_no_cache=true&force_source=db"
                ...
                flag, zero_flag = create_customer_object.comparing_es_vs_db(es_response, db_response,
                                                                            columns=['key',
                                                                                     'median', 'min', 'max',
                                                                                     'total_tickets'],
                                                                            unique_id="across_type with ou id: {}".format(
    ...
    def test_first_assignee_report_filters(self, filter_type, create_generic_object,
                                           create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
    ...
    @pytest.mark.esdbfilter
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_first_assignee_report_exclude_filters(self, filter_type, create_generic_object,
                                                   create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
    ...
    def test_first_assignee_report_dashboard_partial_filters(self, dashboard_partial, create_generic_object,
                                                             create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
