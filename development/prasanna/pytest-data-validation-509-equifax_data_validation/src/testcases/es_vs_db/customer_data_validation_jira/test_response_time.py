...
class TestIssuesCustomer:
    ...
    def test_issue_response_time_report(self, across_type,  create_generic_object,
        ...
        for val in df_sprint:
            try:
                filters = {"projects": project_names, "product_id": create_generic_object.env["project_id"],
                ...
                es_base_url = create_generic_object.connection[
                                  ...
                                  "jira_response_time"] + "?there_is_no_cache=true&force_source=es"
                ...
                db_base_url = create_generic_object.connection[
                                  "base_url"] + create_generic_object.api_data[
                                  "jira_response_time"] + "?there_is_no_cache=true&force_source=db"
    ...
    def test_issue_response_time_trends_report(self,  create_generic_object,
                                                      create_customer_object, get_integration_obj):
        project_names = create_generic_object.env["project_names"]
        df_sprint = create_generic_object.env["set_ous"]
    ...
    def test_issue_response_time_single_stat_report(self,  create_generic_object,
                                                           create_customer_object, get_integration_obj):
        project_names = create_generic_object.env["project_names"]
        df_sprint = create_generic_object.env["set_ous"]
    ...
    def test_issue_response_time_report_filters(self, filter_type, create_generic_object,
                                                create_customer_object, get_integration_obj):
        ...
        for val in df_sprint:
            try:
                ...
                filters = {"integration_ids": get_integration_obj, "sort_xaxis": "value_high-low"}

                filters.update({req_filter_names_and_value_pair[0][0]: req_filter_names_and_value_pair[0][1]})

                payload = {"filter": filters, "across": "assignee", "across_limit": 20,
                           "ou_ids": [val],
                           }
                LOG.info("payload {} ".format(json.dumps(payload)))
    ...
    @pytest.mark.esdbfilter
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_issue_response_time_report_exclude_filters(self, filter_type, create_generic_object,
                                                        create_customer_object, get_integration_obj):
    ...
    def test_issue_response_time_report_dashboard_partial_filters(self, dashboard_partial, create_generic_object,
                                                                  create_customer_object, get_integration_obj):
    ...
    @pytest.mark.esdbfilter
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_issue_response_time_trends_report_filters(self, filter_type, create_generic_object,
                                                       create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
    ...
    @pytest.mark.esdbfilter
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_issue_response_time_trends_report_exclude_filters(self, filter_type, create_generic_object,
                                                               create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
    ...
    @pytest.mark.esdbfilter
    @pytest.mark.parametrize("dashboard_partial", dashboard_partial)
    def test_issue_response_time_trends_report_dashboard_partial_filters(self, dashboard_partial, create_generic_object,
                                                                         create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
    ...
    @pytest.mark.esdbfilter
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_issue_response_time_single_stat_report_filters(self, filter_type, create_generic_object,
                                                            create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
        ...
        for val in df_sprint:
            try:
                ...
                filters = {"time_period": 30, "agg_type": "total",
                           "integration_ids": get_integration_obj}
    ...
    @pytest.mark.esdbfilter
    @pytest.mark.parametrize("filter_type", filter_type)
    def test_issue_response_time_single_stat_report_exclude_filters(self, filter_type, create_generic_object,
                                                                    create_customer_object, get_integration_obj):
        df_sprint = create_generic_object.env["set_ous"]
    ...
    @pytest.mark.esdbfilter
    @pytest.mark.parametrize("dashboard_partial", dashboard_partial)
    def test_issue_response_time_single_stat_report_dashboard_partial_filters(self, dashboard_partial,
